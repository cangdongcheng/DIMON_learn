"""
Geo-DONet helpers  ──  functional MODULE 2 (evaluation) and MODULE 3 (data).

The run Configuration and the CLI both live in main.py; these functions take
their parameters explicitly so they stay free of global defaults.
"""
import numpy as np
import torch
